        ...
        <>
            ...
            <section className='section'>
                ...
                <p>
                    ...
                    propio vehículo 4×4 y en grupo recorremos y desafiamos
                    distintos terrenos naturales. Nuestro servicio te va a
                    incluir el hospedaje, todas las comidas y la guía. Durante
                    el año hacemos travesías en la costa atlántica, la nieve,
                    dunas y montañas. Te vas a encontrar con un ambiente
                    familiar y de camaradería. Si tenés experiencia en 4×4 vas a
                    descubrir desafíos muy divertidos, si no tenés experiencia,
                    no te preocupes, nosotros vamos a ir guiando y ayudándote en
                ...
                <ul>
                    {items.map((item) => (
                        <li key={item.data[0].url}>
                            <h4 className='crono-fecha'>
                                {item.data[0].fecha}
                            </h4>
                            <p className='crono-desc'>
                                <Link
                                    to={item.data[0].url}
                                    className='crono-nombre'>
                                    {item.data[0].nombre} -{' '}
                                </Link>
